      ...
      <main className={styles.main}>
						...
						<Row>
							<Col className="d-flex">
								<div className="my-auto">
									<h1 className="">Pay <span>Small Small</span><br/> on Your Purchase</h1>
									<p className="mb-5">
							...
							<Col>
								<img src="images/chair.png" className="img-fluid" alt="pay small small"/>
							</Col>
						</Row>
					</Container>
				</section>
						...
						<Row>
							<Col xs={12} md={6}>
								<div className="mt-5 mb-5 pt-5 pb-5">
									...
									<p className="text-white mt-5 mb-5">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, 
									...
									<Button variant="outline-primary" className={styles.myBotton}>Get Started</Button>
								</div>
							</Col>
							<Col xs={12} md={6}>
								<img src="images/phone.png" className="img-fluid d-none d-md-block" alt="how it works"/>
							</Col>
						</Row>
					</Container>
				</section>
				<section className={styles.flexible}>
					...
					<Container className="mt-5 mb-5">
						<Row>
							<Col>
								<h2 className="text-center">Offer Online Shoppers Flexible Pay<span>bybit</span> <br/>Options That will Grow Your Business</h2>
							</Col>
						</Row>
						<Row className="mt-5">
							<Col xs={12} md={4}>
								<Card className={`${styles.card} shadow pt-3 pb-3`}>
									<Card.Body className="d-flex">
										...
										<div className="pl-4">
											...
											<Button variant="outline-primary" className={styles.mySmallBotton}>Learn More</Button>
										</div>
									</Card.Body>
								</Card>
							</Col>
